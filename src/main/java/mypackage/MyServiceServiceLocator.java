...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements mypackage.MyServiceService {
    ...
    private java.lang.String MyServicePort_address = "http://localhost:9000/HelloWorld";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service/", "MyServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service/", "MyServicePort"));
        }
